...
<body>
	...
	<div class="loginDiv">
		<form action="/food/modify.do" method="post">
			...
			<div class="row">
				<div class="col-sm-10">
					<input type="text" id="user_loc" name="user_loc" class="form-control"
						style="width: 100%;" value="<%=user.getUser_loc()%>">
				</div>
				<div class="col-sm-2">
		...
		<div class="reg_button">
			<button class="btn btn-success" onclick="submit()">수정하기</button>
			<button class="btn btn-primary px-3"
				onclick="location.href='history.back()'">취소하기</button>
		</div>
		</form>
	</div>
