...
<%
	FoodStrDTO strDTO = (FoodStrDTO) request.getAttribute("strDTO");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div id="main">
		...
		<div class="w3-container">
			...
			<div class="loginDiv">
				<form method="POST" action="/ceo/updateStr.do" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<div class="select_img" id="select_img">
									<img src="/resources/img/<%=strDTO.getStr_img()%>" /> 
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-5">
							<input class="form-control" type="text" id="str_loc"
								name="str_loc" value="<%=strDTO.getStr_loc()%>" size="40"
								placeholder="주소" class="form-contorl">
						</div>
						<div class="col-sm-1">
							<input type="button" onclick="sample5_execDaumPostcode()"
								class="btn btn-primary" value="주소 검색">
						</div>
					</div>
					<br>
					<div class="row">
					...
					<input type="hidden" name="str_no" id="str_no"
						value="<%=strDTO.getStr_no()%>" />
					<input type="hidden" name="str_img" id="str_img" value="<%=strDTO.getStr_img()%>" />
				</form>
				<br> <br>
			</div>
		</div>
